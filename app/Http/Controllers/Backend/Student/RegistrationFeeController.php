...
class RegistrationFeeController extends Controller
{
    ...
    public function ViewRegistrationFeeClasswise(Request $request)
    {
    ...
    public function ViewRegistrationFeePayslip(Request $request)
    {
        ...
        $pdf = PDF::loadView('backend.student.registration_fee.registration_details_pdf', $allStudent);
