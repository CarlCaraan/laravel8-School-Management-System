                ...
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-4 col-md-5 col-12">
                        ...
                        <div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            <x-jet-validation-errors class="m-4 text-light" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="fog-pwd text-right">
                                            <a href="{{ route('password.request') }}" class="text-white hover-success"><i class="ion ion-locked"></i> Forgot password?</a><br>
                                        </div>
                                    </div>
                                    <!-- /.col -->
