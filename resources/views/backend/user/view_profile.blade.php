...
@section('title') {{ Auth::user()->name }} | ASMS @endsection
                ...
                <div class="col-12">
                    <div class="box box-widget widget-user">
                        ...
                        <div class="widget-user-image">
                            <img class="rounded-circle" style="width: 90px; height: 90px;" src="{{ (!empty($user->image)) ? url('upload/user_images/'.$user->image) : url('upload/no_image.jpg') }}" alt="User Avatar">
                        </div>
