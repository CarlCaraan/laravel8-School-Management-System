...
@section('title') Promote Student | ASMS @endsection
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="POST" action="{{ route('student.registration.promote',$editData->student_id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="text-xs-right">
                                    <input type="submit" class="btn btn-info btn-rounded mb-5" value="Promotion">
                                </div>
                            </form>
