...
@section('title') Marksheet Pdf | ASMS @endsection
                        ...
                        <div class="box-body" style="border: solid 1px; padding: 10px;">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center" style="float: left;">
                                    ...
                                    <h6><strong>Manila Philippines</strong></h6>
                                    <h5><u><i>Academic Transcript</i></u></h5>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table border="1" style="border-color: #ffffff;" width="100%" cellpadding="1" cellspacing="1">
                                        @php
                                        $total_grade = 0;
                                        $get_grade = (float)$total_point/(float)$total_subject;
                                        $point_for_letter_grade = number_format((float)$get_grade,2);
